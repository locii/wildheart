...
export function IntakeForm({ appointmentId, successHref, backHref }: Props) {
  ...
  if (loading) {
    return (
      <BookingShell backHref={backHref} backLabel="Back">
    ...
    return (
      <BookingShell backHref={backHref} backLabel="Back">
        <div className="px-8 py-12 text-center">
          ...
          <Button onClick={() => router.push(successHref)}>Continue</Button>
        </div>
      </BookingShell>
    );
  }
